...
const BLOG = {
  ...
  AUTHOR: 'hermanjun', // 作者
  BIO: '', // 作者简介
  LINK: 'hermanjun.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'luojunherman@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/JunLuoHerman', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/HermanLJ', // 你的github个人主页
